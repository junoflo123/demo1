...
<body>
	...
	<?php
		if(isset($_POST["dangky"])){
			...
			if($pass1!=$pass2){
				header("location:index1.php?page=dangky");
	...
	<div class="container">
		<div class="row">
			<a href="index1.php?page=dangky" class="btn btn-success">Đăng ký</a>
			<a href="index1.php" class="btn btn-info">Trang chủ</a>
			<?php if(isset($_SESSION["loged"])) echo "<a href='index1.php?act=logout' class='btn btn-danger'>Đăng xuất</a>"; ?>
		</div>
